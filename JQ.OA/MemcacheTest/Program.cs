...
namespace MemcacheTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Setup memcache server cluster
            string[] serverlist = { "127.0.0.1:11211"}; //List the memcache servers in the list
            ...
            for (int i = 0; i < 10; i++)
            {
 mc.Set("test", "my value"+i.ToString());  //存储数据到缓存服务器，这里将字符串"my ue"缓存，key 是"test"
